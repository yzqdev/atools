...
<template>
  <n-space vertical size="large" class="reg-test">
      ...
      <n-layout-header>
        <n-card style="margin-bottom: 20px">
          <n-space align="center">
            ...
            <n-button type="info" @click.stop="setTestSource">生成测试字符串</n-button>
            <n-button
            ...
            <n-button type="error" @click.stop="clearAll">清空</n-button>
          </n-space>
        </n-card>
      </n-layout-header>
      <n-layout has-sider>
        <n-layout-content>
          <n-space vertical size="large">
            <n-alert type="info" v-if="containsSpace">注意,你的正则表达式内有空格,需要谨慎</n-alert>
          ...
          <n-card style="margin-top: 20px" title="常用正则表达式">
            <n-alert type="info">点击表达式可以直接在上面测试</n-alert>
            <div class="card-body">
              <h2>一、校验数字的表达式</h2>
              <ul>
        ...
        >
          <n-table>
            ...
            <tr>
              ...
              <td>
                默认情况下的圆点 <span class="marked">.</span> 是匹配除换行符
                <span class="marked">\n</span> 之外的任何字符，加上
